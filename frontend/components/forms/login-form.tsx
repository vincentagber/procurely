  ...
  return (
    ...
    >
      ...
      >
       ...
       {/* Social login buttons - TODO: Implement OAuth integration */}
       <button
         className="flex h-12 w-full items-center justify-center gap-3 rounded-full border border-slate-200 bg-white text-sm font-bold text-[#13184f] transition hover:bg-slate-50 hover:border-slate-300 shadow-sm opacity-50 cursor-not-allowed"
         type="button"
         disabled
       >
