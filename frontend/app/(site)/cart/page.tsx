...
export const metadata: Metadata = {
  title: "Shopping Cart | Procurely",
  description: "Review your building materials cart on Procurely.",
};
    ...
    <div className="bg-[#f6f7fd]">
      ...
      <div className="container-shell mx-auto px-4 py-6 sm:px-6">
        <p className="text-sm font-medium text-slate-400">
          Home <span className="mx-2">/</span> pages <span className="mx-2">/</span> <span className="text-[#13184f] font-semibold">Cart</span>
        </p>
      </div>
