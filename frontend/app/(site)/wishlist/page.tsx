...
export const metadata: Metadata = {
  title: "Wishlist | Procurely",
  description: "View and manage your saved building materials.",
};
...
export default async function WishlistPage() {
  ...
  return (
    <div className="bg-[#f6f7fd]">
      {/* Breadcrumb Header */}
      <div className="container-shell mx-auto px-4 py-10 sm:px-6 lg:px-8">
        <p className="text-sm font-bold tracking-wide text-slate-400">
          Home <span className="mx-3 text-slate-300">/</span> Pages <span className="mx-3 text-slate-300">/</span> <span className="text-[#13184f]">Wishlist</span>
        </p>
      </div>

      {/* Interactive Wishlist & Just For You */}
      <WishlistClient suggestedProducts={content.products} />
